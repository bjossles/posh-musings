...
function Save-LocationBookmark
{
    ...
    if(-not (test-path $location))
    {
        ...
        {
            Write-Warning "Location references a path that doesn't exist!"
    # At this point I sufficed with a warning allowing the path to be created later, alternately an error could be thrown
        }          
